    ...
    },
    {
      ...
      objects = {
        ...
        },
        {
          ...
          properties = {
            ["marker"] = "spam",
            ["text1"] = "* There are more savepoints in this room than usual.",
            ["text2"] = "* The power of entity spam shines within you."
          }
        },
        {
          id = 42,
          ...
          properties = {
            ["marker"] = "starw",
            ["text1"] = "* There's a simple NPC example nearby.",
            ["text2"] = "* The power of the \noriginal[wait:20]     [color:yellow]Starwalker[color:reset] shines within you."
          }
        },
        {
          id = 45,
